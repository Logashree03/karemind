...
import radioban from "../../../assets/radioban.png";
...
const RadiologyBanner = ({
    titleTop = "Radiology Information",
    titleHighlight = "Management System",
    titleBottom = "",
    description = "Innovative RIS and PACS Software for Medical Practices & Hospitals",

    image = radioban,
    imageAlt = "Radiology Information & Management Software",
