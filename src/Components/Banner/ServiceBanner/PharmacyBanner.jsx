...
const PharmacyBanner = ({
  ...
  titleBottom = "",
  description = "Make your Pharmacy store Management profitable with Karemind   ",
            ...
            <div className="hospital-bottom-features">
              ...
              <div className="hospital-bottom-item">
                ...
                <div>
                  ...
                  <p>
                    GST report ready; pharmacy P&L report and other critical analytics
                  </p>
                </div>
              </div>
              ...
              <div className="hospital-bottom-item">
                ...
                <div>
                  ...
                  <p>
                    One solution for pharmacy within clinic or hospital, retail pharmacy, and chain of pharmacies
                  </p>
                </div>
              </div>
              ...
              <div className="hospital-bottom-item">
                ...
                <div>
                  <h4>Billing & EHR</h4>
                  <p>
                    Real-time inventory for optimized purchases
                  </p>
                </div>
              </div>
