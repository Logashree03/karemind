...
const HospitalBanner = ({
  titleTop = "Hospital Information ",
  titleHighlight = "Management System",
  titleBottom = "",
  description = "Join the future of healthcare with Karemind Hospital Information Management System.",

  image = HMS,
  imageAlt = "Hospital Management System",

  buttonText = "Explore Now",
  websiteText = "www.karemind.com",
