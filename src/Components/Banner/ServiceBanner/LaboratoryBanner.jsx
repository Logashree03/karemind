...
import lababan from "../../../assets/lababan.png";
...
const LaboratoryBanner = ({
    titleTop = "Laboratory Information",
    titleHighlight = "Management System",
    titleBottom = "",
    description = "Unlock enhanced productivity, efficiency, and compliance in your lab with Karemind intelligent software suite. Automate operations, reduce inaccuracies, and empower staff to focus on quality patient care.",

    image = lababan,
    imageAlt = "Laboratory Information Management System",
                ...
                <div className="hospital-banner-main">
                    ...
                    <div className="hospital-banner-image">
                        <img
                            src={image}
                            alt={imageAlt}
                            className="banner-image banner-laboratory"
                        />
                    </div>
